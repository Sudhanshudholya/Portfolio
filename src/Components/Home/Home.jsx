    ...
    <div className="text-white flex flex-col-reverse md:flex-row w-full items-center justify-between p-10 md:p-20">
      ...
      <div className="md:w-2/4 md:pt-10 text-center md:text-left">
        ...
        <p className="text-sm md:text-xl mt-3 text-gray-300">
          ...
          technology stack. They handle both frontend and backend development,
          ensuring seamless integration between the client and server.
        </p>

        <button
          className="mt-5 md:mt-10 text-white py-2 px-4 md:py-3 md:px-6 text-sm md:text-lg font-semibold rounded-full bg-[#465697] hover:bg-[#3a4b8a] transition-transform transform hover:scale-105 duration-300 shadow-lg cursor-pointer"
          onClick={() =>
            document
      ...
      <div className="flex justify-center">
        <img
          className="w-72 md:w-96 rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
          src={avatar}
          alt="Avatar"
        />
      </div>
